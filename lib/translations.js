const translations = {
  en: {
    ...
    credit: `
  Created by Alex Barnard using Github and Vercel. Each time this app loads, it scrapes data from the CNES website, meaning that it is up to date at the time the app is opened. 
