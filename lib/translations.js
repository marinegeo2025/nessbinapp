...
const translations = {
  ...
  This app uses data sourced from the CNES website and refreshed automatically on a regular schedule, so you always see the most up-to-date information available. 
...
`,
  ...
  <strong>NessBinApp Tee</strong><br />
  If you find NessBinApp useful and want to support its continued development,
  you can grab the official <strong>BINFLUENCER™ NessBinApp T-Shirt</strong> —  
  for the people who never miss bin day and quietly keep the street in order.
  <br />
  👉 <a 
    href="https://store.daisyscoldwatersurfteam.com/products/nessbinapp-tee" 
    target="_blank" 
    rel="noopener noreferrer"
  >
    Get the NessBinApp Tee
  </a>
  <br /><br />
  ...
  <br />
  📬 To advertise here, for questions, or updates: 
...
`,
    ...
    // Festive message
    festiveMessage: "🎅 Merry Christmas and Happy New Year from the team at NessBinApp! 🎄",
    ...
    // --- Area names ---
    northNess: "North Ness",
    southNess: "South Ness",
  ...
  Tha an aplacaid seo a’ cleachdadh dàta bhon làrach-lìn ChNES, a tha air ùrachadh gu fèin-obrachail air clàr cunbhalach, gus dèanamh cinnteach gu bheil am fiosrachadh cho ùr ’s a ghabhas. 
  Tha an dàta seo bho 
  <a href="https://www.cne-siar.gov.uk/bins-and-recycling" target="_blank">
...
`,
  ...
  <strong>Lèine-T NessBinApp</strong><br />
  Ma tha NessBinApp feumail dhut agus ma tha thu airson taic a chur ri leasachadh leantainneach an aplacaid,
  faodaidh tu an <strong>Lèine-T Oifigeil BINFLUENCER™ NessBinApp</strong> fhaighinn —  
  airson nan daoine nach caill latha cruinneachaidh a-riamh
  agus a chumas an t-sràid ann an deagh òrdugh gu sàmhach.
  <br />
  👉 <a 
    href="https://store.daisyscoldwatersurfteam.com/products/nessbinapp-tee" 
    target="_blank" 
  ...
  <br />
  📬 Gus sanas a chur an seo, airson cheistean no ùrachaidhean: 
  <a href="#" onclick="this.innerText='al@daisyscoldwatersurfteam.com'; return false;">
...
`,
    ...
    // Festive message
    festiveMessage: "🎅 Nollaig Chridheil agus Bliadhna Mhath Ùr bhon sgioba aig NessBinApp! 🎄",
    ...
    // --- Area names ---
    northNess: "Nis a Tuath",
    southNess: "Nis a Deas",
