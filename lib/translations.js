const translations = {
  en: {
    ...
    credit:
      "Created by Alex Barnard using Github and Vercel. Each time this app loads, it scrapes data from the CNES website, meaning that it is up to date at the time the app is opened. The data used are from CNES Bins and Recycling.",
    licence:
      "This free tool is shared under a Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International licence.",
    cute: "💚 WE LOVE NESS! 💚",

    // --- Bin pages ---
    blackTitle: "BLACK Bin Collection Dates",
    blackNess: "Ness – Knockaird, Fivepenny, Butt, Eoropie, Port of Ness, Lionel, Eorodale, Adabrock, Cross Skigersta",
  ...
  gd: {
    ...
    northVillages:
      "(Cnoc Àrd, Còig Peighinnean, Rubha, Eòropaidh, Port Nis, Lìonal, Eòradal, Adabroc, Cros Sgiogarstaidh)",
    southSchedule: "Clàr Bhionaichean Nis a Deas",
    southVillages: "(Tobson, Suaineabost, Cros, Dail bho Thuath is Deas)",
    credit:
      "Air a chruthachadh le Alex Barnard a’ cleachdadh Github agus Vercel. Gach turas a luchdaicheas an aplacaid seo, bidh e a’ sgrìobadh dàta bhon làrach-lìn ChNES, agus mar sin tha e suas gu latha nuair a thèid fhosgladh. Tha an dàta seo bho CNES Bionaichean is Ath-chuairteachadh.",
    licence:
      "Tha an inneal an-asgaidh seo air a roinn fo Ceadachas Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International.",
    cute: "💚 GRÀDH MÒR AIR NIS! 💚",

    // --- Bin pages ---
    blackTitle: "BIONA DUBH – Cinn-latha Cruinneachaidh",
    blackNess: "Nis – Cnoc Àrd, Còig Peighinnean, Rubha, Eòropaidh, Port Nis, Lìonal, Eòradal, Adabroc, Cros Sgiogarstaidh",
    ...
    noData: "Cha deach cinn-latha cruinneachaidh bhionaichean a lorg. Feuch ris ath-luchdachadh an duilleag nas fhaide air adhart.",
